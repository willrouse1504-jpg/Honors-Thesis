...
The sample is the FDIC Statistics on Depository Institutions bank-quarter panel from 1992Q1 to 2026Q2, with 1{,}127{,}856 bank-quarters and 17{,}121 institutions identified by FDIC certificate number. Insured U.S. branches of foreign banks (FDIC charter class OI; 40 institutions, 2{,}069 bank-quarters) are excluded: they report assets but no equity or income, and the FDIC records their ROA and NIM as zero, which would otherwise enter the distributions as spurious zero changes. In each quarter $t$, banks are ranked by total assets. The top 1\% form the \emph{large-bank} group (between 42 and 143 institutions, depending on the year) and the remaining 99\% form the \emph{other-bank} group. Important note, for the actual analysis portion, the 1\% value will likely have to be extended to 5\% or 10\% to satisfy the data needs of both bootstrap resampling or maximum likelihood estimation. Group membership is re-assigned every quarter.
